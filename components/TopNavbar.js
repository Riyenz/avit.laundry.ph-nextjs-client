  ...
  return (
    <div className='w-full flex flex-col justify-center items-center shadow-lg'>
      <div className='avit-container py-2 items-center hidden lg:flex'>
        <p className='text-[#7b7d83] text-[14px] font-medium'>Welcome to AVIT Laundry Services!</p>
      ...
      <div className='avit-container py-3 flex items-center lg:py-6'>
        ...
        />
        <img className='h-[40px] lg:hidden' src='/images/AVIT_LAUNDRY_LOGO.svg' alt='AVIT_LAUNDRY_LOGO' />

        <div className='ml-auto grid grid-flow-col gap-6'>
          <div className='items-center hidden sm:flex'>
            <Icon name='email' className='w-[30px] h-[30px] mr-4' />
            <div className='flex flex-col'>
              <p className='text-[14px] text-[#7b7d83] font-medium'>hello@avit.ph</p>
              <a href='mailto:hello@avit.ph' className='text-primary text-[15px] font-bold hover:opacity-90'>
                Send Email
              </a>
            </div>
          </div>
          ...
          <div className='items-center hidden lg:flex'>
            ...
            <div className='flex flex-col'>
              <p className='text-[14px] text-[#7b7d83] font-medium'>Mon to Sun</p>
          ...
          <div className='items-center flex'>
            ...
            <div className='flex flex-col'>
              <p className='text-[14px] text-[#7b7d83] font-medium'>Call Anytime</p>
              <a href='tel:+639761508120' className='text-primary text-[15px] font-bold hover:opacity-90'>
                +63 976 150 8120
              </a>
            </div>
          </div>
          ...
          <div className='items-center hidden md:flex'>
            ...
            <div className='flex flex-col'>
              <p className='text-[14px] text-[#7b7d83] font-medium'>BLK 1 LOT 10 Terra Alta Homes</p>
              <p className='text-primary text-[15px] font-bold'>Dasmariñas Cavite</p>
            </div>
          </div>
        </div>
      </div>
